TASK_TO_PROMPT = {
    'eng': {
        ...
        # Tasks.RHETORIC_MODE_CLASSIFICATION
        'RMC': [
            'Classify the type of the paragraph below.\n[INPUT] => Emotion ([OPTIONS]): [LABELS_CHOICE]',
            'Predict the type of the following paragraph.\nText: [INPUT]\nAnswer with [OPTIONS]: [LABELS_CHOICE]',
            '[INPUT]\nWhat would be the type of the paragraph above? [OPTIONS]? [LABELS_CHOICE]',
            # 'What is the type of this paragraph?\nText: [INPUT]\nEmotion ([OPTIONS]): [LABELS_CHOICE]',
            # 'Text: [INPUT]\nPlease classify the type of above paragraph. Answer with [OPTIONS].\nEmotion: [LABELS_CHOICE]',
        ],
    ...
    'ind': {
        ...
        'TL': [
            ...
            '[INPUT]\nApakah topik dari kalimat diatas? [OPTIONS]? [LABELS_CHOICE]',
            # 'Apakah topik dari teks berikut?\nTeks: [INPUT]\nEmosi ([OPTIONS]): [LABELS_CHOICE]',
            # 'Teks: [INPUT]\nTolong klasifikasikan topik dari teks diatas. Jawab dengan [OPTIONS].\nEmosi: [LABELS_CHOICE]',
        ],
        # Tasks.RHETORIC_MODE_CLASSIFICATION
        'RMC': [
            'Klasifikasikan jenis dari paragraf berikut.\n[INPUT] => Emosi ([OPTIONS]): [LABELS_CHOICE]',
            'Prediksikan jenis dari paragraf berikut.\nTeks: [INPUT]\nJawab dengan [OPTIONS]: [LABELS_CHOICE]',
            '[INPUT]\nApakah jenis dari paragraf diatas? [OPTIONS]? [LABELS_CHOICE]',
            # 'Apakah jenis dari paragraf berikut?\nTeks: [INPUT]\nEmosi ([OPTIONS]): [LABELS_CHOICE]',
            # 'Teks: [INPUT]\nTolong klasifikasikan jenis dari paragraf diatas. Jawab dengan [OPTIONS].\nEmosi: [LABELS_CHOICE]',
        ],
        # Task
        # Tasks.LEGAL_CLASSIFICATION
        'LC':  [
...
LABEL_LANG_MAP ={
	...
	'emot_nusantara_text' : {
    	'eng': {'happy': 'happy', 'love': 'love', 'fear': 'fear', 'anger': 'anger', 'sadness': 'sadness'},
    	'ind': {'happy': 'senang', 'love': 'cinta', 'fear': 'takut', 'anger': 'marah', 'sadness': 'sedih'}
    },
    'nusaparagraph_emot_btk_nusantara_text' : {
    	'eng': {'fear': 'fear', 'disgusted': 'disgusted', 'sad': 'sad', 'happy': 'happy', 'angry': 'angry', 'surprise': 'surprise', 'shame': 'shame'},
    	'ind': {'fear': 'takut', 'disgusted': 'jijik', 'sad': 'sedih', 'happy': 'senang', 'angry': 'marah', 'surprise': 'kaget', 'shame': 'malu'}
    },
    ...
    'nusaparagraph_rhetoric_btk_nusantara_text' : {
    	'eng': {'narrative': 'narrative', 'persuasive': 'persuasive', 'argumentative': 'argumentative', 'descriptive': 'descriptive', 'expository': 'expository'},
    	'ind': {'narrative': 'naratif', 'persuasive': 'persuasif', 'argumentative': 'argumentatif', 'descriptive': 'descriptif', 'expository': 'ekspositori'}
    },
    ...
    'nusaparagraph_topic_bew_nusantara_text' : {
    	...
    	'ind': {'food & beverages': 'makanan dan minuman', 'sports': 'olahraga', 'leisures': 'wisata', 'religion': 'agama', 'culture & heritage': 'budaya', 'slice of life': 'kehidupan sehari-hari', 'technology': 'teknologi', 'business': 'bisnis'}
    },
    ...
    'nusatranslation_emot_abs_nusantara_text' : {
    	'eng': {'fear': 'fear', 'sadness': 'sadness', 'happy': 'happy', 'anger': 'anger', 'love': 'love'},
    	'ind': {'fear': 'takut', 'sadness': 'sedih', 'happy': 'senang', 'anger': 'marah', 'love': 'cinta'}
    },
